...
%-----------EXPERIENCE-----------
\section{Research Experience and Internships}
  \resumeSubHeadingListStart
    \resumeSubheading
      {UW-Madison Qool Quantum Qompilers Lab}{September 2025 -- Present}
      {Quantum Compilers Researcher with Prof. Aws Albarghouthi}{Remote}
      \resumeItemListStart
        \resumeItem{Implemented key parallelization for QQQ's synthesis-based optimizing quantum compiler WISQ}
      \resumeItemListEnd
    ...
    \resumeSubheading
      {Georgia Tech Computational Physics Lab}{Aug 2022 -- July 2023}
      {Quantum Algorithms Researcher with Prof. Spencer Bryngelson}{Atlanta, GA}
      \resumeItemListStart
...
\section{Projects}
    \resumeSubHeadingListStart
     ...
     \resumeProjectHeading{\textbf{Verified Randomized Maxcut Approximation Algorithm} $|$ \emph{Lean}}{}
          \resumeItemListStart
            \resumeItem{Designed data structures and proof objects to represent MaxCut instances induced by randomized vertex selection}
            \resumeItem{Created lemmas and theorems to prove random vertex partitions create a $\frac{1}{2}$-approximation in expectation}
          \resumeItemListEnd
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Languages}{: Rust, Python, Java, C, C++, Lean, LLVM, MLIR, JavaScript, LateX} \\
